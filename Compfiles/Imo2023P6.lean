...
lemma hradCL (u v R : ℝ) (x y : ℝ) : (6 * (u-v) * (u*v - u - v - 3)^3) * (((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (x^2+y^2) + (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * x + ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) * y + ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3))) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((6 * (u-v) * (u*v - u - v - 3)^3) * (x^2+y^2) + (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v)) * x + ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3) * y + (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) = ((6 * (u-v) * (u*v - u - v - 3)^3) * (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v))) * x + ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3)) * y + ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) := by
  set dA : ℝ := (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) with hdA
  set w : ℝ := (u*v - u - v - 3) with hww
  ring

lemma hcoaxxL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v))) = (u*v - u - v - 3)^2 * ((288 * R * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 3 * v - u ^ 3 + u ^ 2 * v ^ 2 - u ^ 2 * v - 4 * u * v ^ 2 + 3 * u * v - 15 * u + 3 * v ^ 2 - 3 * v))) := by
  set dA : ℝ := (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) with hdA
...
lemma hcoaxyL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3)) = (u*v - u - v - 3)^2 * (((-96) * R * (u^2+3) * (v^2+3) * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * Real.sqrt 3)) := by
  set dA : ℝ := (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) with hdA
  have h1 : (u - v) * (u*v - u - v - 3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9)
      + 2 * v * (u^2+3) * dA * (v - 3)
      = (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) := by
    rw [hdA]; ring
  linear_combination ((-96) * R * (u^2+3) * (v^2+3) * Real.sqrt 3 * (u*v - u - v - 3)^2) * h1

lemma hcoaxcL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) = (u*v - u - v - 3)^2 * (((-288) * R^2 * (u-v) * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3))) := by
  set dA : ℝ := (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) with hdA
  set dB : ℝ := (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3) with hdB
  have h1 : (u - 1) * (u*v - u - v - 3) - 4 * (u + v) = dB := by rw [hdB]; ring
