...
lemma incAA2 (u v u₃ R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3)
  ...
  field_simp [hdenD]
  linear_combination ((-1) * 4 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v ^ 5 + 28 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v ^ 4 - 72 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v ^ 3 + 120 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v ^ 2 - 180 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v + 108 * R ^ 2 * u ^ 2 * u₃ ^ 2 + 4 * R ^ 2 * u ^ 2 * u₃ * v ^ 6 - 24 * R ^ 2 * u ^ 2 * u₃ * v ^ 5 + 60 * R ^ 2 * u ^ 2 * u₃ * v ^ 4 - 144 * R ^ 2 * u ^ 2 * u₃ * v ^ 3 + 252 * R ^ 2 * u ^ 2 * u₃ * v ^ 2 - 216 * R ^ 2 * u ^ 2 * u₃ * v + 324 * R ^ 2 * u ^ 2 * u₃ - 4 * R ^ 2 * u ^ 2 * v ^ 6 + 12 * R ^ 2 * u ^ 2 * v ^ 5 + 24 * R ^ 2 * u ^ 2 * v ^ 4 - 72 * R ^ 2 * u ^ 2 * v ^ 3 + 108 * R ^ 2 * u ^ 2 * v ^ 2 - 324 * R ^ 2 * u ^ 2 * v - 120 * R ^ 2 * u * u₃ ^ 2 * v ^ 4 + 144 * R ^ 2 * u * u₃ ^ 2 * v ^ 3 - 288 * R ^ 2 * u * u₃ ^ 2 * v ^ 2 + 432 * R ^ 2 * u * u₃ ^ 2 * v + 216 * R ^ 2 * u * u₃ ^ 2 + 144 * R ^ 2 * u * u₃ * v ^ 5 - 96 * R ^ 2 * u * u₃ * v ^ 4 + 576 * R ^ 2 * u * u₃ * v ^ 3 - 288 * R ^ 2 * u * u₃ * v ^ 2 + 432 * R ^ 2 * u * u₃ * v - 24 * R ^ 2 * u * v ^ 6 - 48 * R ^ 2 * u * v ^ 5 - 288 * R ^ 2 * u * v ^ 4 - 144 * R ^ 2 * u * v ^ 3 - 648 * R ^ 2 * u * v ^ 2 - 60 * R ^ 2 * u₃ ^ 2 * v ^ 5 + 156 * R ^ 2 * u₃ ^ 2 * v ^ 4 - 72 * R ^ 2 * u₃ ^ 2 * v ^ 3 + 360 * R ^ 2 * u₃ ^ 2 * v ^ 2 + 324 * R ^ 2 * u₃ ^ 2 * v - 324 * R ^ 2 * u₃ ^ 2 + 60 * R ^ 2 * u₃ * v ^ 6 - 120 * R ^ 2 * u₃ * v ^ 5 + 36 * R ^ 2 * u₃ * v ^ 4 - 432 * R ^ 2 * u₃ * v ^ 3 - 540 * R ^ 2 * u₃ * v ^ 2 - 216 * R ^ 2 * u₃ * v - 324 * R ^ 2 * u₃ - 36 * R ^ 2 * v ^ 6 + 36 * R ^ 2 * v ^ 5 + 72 * R ^ 2 * v ^ 4 + 216 * R ^ 2 * v ^ 3 + 540 * R ^ 2 * v ^ 2 + 324 * R ^ 2 * v) * hw + (24 * R ^ 2 * u * u₃ * v ^ 5 - 72 * R ^ 2 * u * u₃ * v ^ 4 - 216 * R ^ 2 * u * u₃ * v + 648 * R ^ 2 * u * u₃ - 48 * R ^ 2 * u * v ^ 5 + 144 * R ^ 2 * u * v ^ 4 - 144 * R ^ 2 * u * v ^ 3 + 432 * R ^ 2 * u * v ^ 2 + 24 * R ^ 2 * u₃ * v ^ 5 - 216 * R ^ 2 * u₃ * v ^ 4 + 576 * R ^ 2 * u₃ * v ^ 3 - 864 * R ^ 2 * u₃ * v ^ 2 + 1512 * R ^ 2 * u₃ * v - 648 * R ^ 2 * u₃ + 144 * R ^ 2 * v ^ 4 - 432 * R ^ 2 * v ^ 3 + 432 * R ^ 2 * v ^ 2 - 1296 * R ^ 2 * v) * hrel
...
lemma incBB1 (u v R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3) : (24 * u ^ 4 * v - 24 * u ^ 4 - 48 * u ^ 3 * v - 144 * u ^ 3 - 144 * u * v - 432 * u - 216 * v + 216) * ((R * (1 - v) / 4)^2 + (R * Real.sqrt 3 * (v - 1) / 4)^2) + (12 * R * u ^ 4 * v ^ 2 + 84 * R * u ^ 4 - 48 * R * u ^ 3 * v ^ 2 + 96 * R * u ^ 3 * v - 144 * R * u ^ 3 + 72 * R * u ^ 2 * v ^ 2 + 216 * R * u ^ 2 - 144 * R * u * v ^ 2 + 288 * R * u * v - 432 * R * u + 108 * R * v ^ 2 - 108 * R) * (R * (1 - v) / 4) + ((-1) * 4 * R * u ^ 4 * v ^ 2 * Real.sqrt 3 + 36 * R * u ^ 4 * Real.sqrt 3 + 96 * R * u ^ 3 * v * Real.sqrt 3 + 24 * R * u ^ 2 * v ^ 2 * Real.sqrt 3 + 72 * R * u ^ 2 * Real.sqrt 3 + 288 * R * u * v * Real.sqrt 3 + 108 * R * v ^ 2 * Real.sqrt 3 - 108 * R * Real.sqrt 3) * (R * Real.sqrt 3 * (v - 1) / 4) + (12 * R ^ 2 * u ^ 4 * v ^ 2 - 24 * R ^ 2 * u ^ 4 * v + 12 * R ^ 2 * u ^ 4 - 24 * R ^ 2 * u ^ 3 * v ^ 2 - 48 * R ^ 2 * u ^ 3 * v + 72 * R ^ 2 * u ^ 3 - 72 * R ^ 2 * u * v ^ 2 - 144 * R ^ 2 * u * v + 216 * R ^ 2 * u - 108 * R ^ 2 * v ^ 2 + 216 * R ^ 2 * v - 108 * R ^ 2) = 0 := by linarith only [incBB1aux u v R hw]
lemma incBB2 (u v u₃ R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3)
  ...
  field_simp [hdenD]
  linear_combination (8 * R ^ 2 * u ^ 6 * u₃ ^ 2 * v ^ 2 + 24 * R ^ 2 * u ^ 6 * u₃ ^ 2 * v - 96 * R ^ 2 * u ^ 6 * u₃ ^ 2 - 16 * R ^ 2 * u ^ 6 * u₃ * v ^ 2 - 48 * R ^ 2 * u ^ 6 * u₃ * v + 192 * R ^ 2 * u ^ 6 * u₃ + 8 * R ^ 2 * u ^ 6 * v ^ 2 + 24 * R ^ 2 * u ^ 6 * v - 96 * R ^ 2 * u ^ 6 - 32 * R ^ 2 * u ^ 5 * u₃ ^ 2 * v ^ 2 - 384 * R ^ 2 * u ^ 5 * u₃ ^ 2 * v + 288 * R ^ 2 * u ^ 5 * u₃ ^ 2 + 32 * R ^ 2 * u ^ 5 * u₃ * v ^ 2 + 768 * R ^ 2 * u ^ 5 * u₃ * v - 288 * R ^ 2 * u ^ 5 * u₃ - 384 * R ^ 2 * u ^ 5 * v - 24 * R ^ 2 * u ^ 4 * u₃ ^ 2 * v ^ 2 + 1272 * R ^ 2 * u ^ 4 * u₃ ^ 2 * v + 288 * R ^ 2 * u ^ 4 * u₃ ^ 2 + 144 * R ^ 2 * u ^ 4 * u₃ * v ^ 2 - 1776 * R ^ 2 * u ^ 4 * u₃ * v - 1440 * R ^ 2 * u ^ 4 * u₃ - 120 * R ^ 2 * u ^ 4 * v ^ 2 + 504 * R ^ 2 * u ^ 4 * v + 1152 * R ^ 2 * u ^ 4 + 192 * R ^ 2 * u ^ 3 * u₃ ^ 2 * v ^ 2 - 1728 * R ^ 2 * u ^ 3 * u₃ ^ 2 * v - 1152 * R ^ 2 * u ^ 3 * u₃ ^ 2 - 192 * R ^ 2 * u ^ 3 * u₃ * v ^ 2 + 1152 * R ^ 2 * u ^ 3 * u₃ * v + 2880 * R ^ 2 * u ^ 3 * u₃ + 576 * R ^ 2 * u ^ 3 * v - 1728 * R ^ 2 * u ^ 3 - 360 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v ^ 2 + 2952 * R ^ 2 * u ^ 2 * u₃ ^ 2 * v + 2592 * R ^ 2 * u ^ 2 * u₃ ^ 2 + 144 * R ^ 2 * u ^ 2 * u₃ * v ^ 2 - 3600 * R ^ 2 * u ^ 2 * u₃ * v - 6912 * R ^ 2 * u ^ 2 * u₃ + 216 * R ^ 2 * u ^ 2 * v ^ 2 + 648 * R ^ 2 * u ^ 2 * v + 4320 * R ^ 2 * u ^ 2 + 864 * R ^ 2 * u * u₃ ^ 2 * v ^ 2 - 1728 * R ^ 2 * u * u₃ ^ 2 * v - 6048 * R ^ 2 * u * u₃ ^ 2 - 864 * R ^ 2 * u * u₃ * v ^ 2 - 3456 * R ^ 2 * u * u₃ * v + 11232 * R ^ 2 * u * u₃ + 5184 * R ^ 2 * u * v - 5184 * R ^ 2 * u - 648 * R ^ 2 * u₃ ^ 2 * v ^ 2 - 1944 * R ^ 2 * u₃ ^ 2 * v + 2592 * R ^ 2 * u₃ ^ 2 - 1296 * R ^ 2 * u₃ * v ^ 2 + 3888 * R ^ 2 * u₃ * v - 2592 * R ^ 2 * u₃ + 1944 * R ^ 2 * v ^ 2 - 1944 * R ^ 2 * v) * hw + ((-1) * 96 * R ^ 2 * u ^ 5 * u₃ * v - 96 * R ^ 2 * u ^ 5 * u₃ + 192 * R ^ 2 * u ^ 5 * v + 288 * R ^ 2 * u ^ 4 * u₃ * v + 864 * R ^ 2 * u ^ 4 * u₃ - 576 * R ^ 2 * u ^ 4 * v - 576 * R ^ 2 * u ^ 4 - 2304 * R ^ 2 * u ^ 3 * u₃ + 576 * R ^ 2 * u ^ 3 * v + 1728 * R ^ 2 * u ^ 3 + 3456 * R ^ 2 * u ^ 2 * u₃ - 1728 * R ^ 2 * u ^ 2 * v - 1728 * R ^ 2 * u ^ 2 + 864 * R ^ 2 * u * u₃ * v - 6048 * R ^ 2 * u * u₃ + 5184 * R ^ 2 * u - 2592 * R ^ 2 * u₃ * v + 2592 * R ^ 2 * u₃) * hrel
...
lemma incCC (u v R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3) : (6 * u ^ 4 * v ^ 3 - 18 * u ^ 4 * v ^ 2 + 18 * u ^ 4 * v - 6 * u ^ 4 - 6 * u ^ 3 * v ^ 4 - 36 * u ^ 3 * v ^ 2 + 96 * u ^ 3 * v - 54 * u ^ 3 + 18 * u ^ 2 * v ^ 4 + 36 * u ^ 2 * v ^ 3 + 108 * u ^ 2 * v - 162 * u ^ 2 - 18 * u * v ^ 4 - 96 * u * v ^ 3 - 108 * u * v ^ 2 - 162 * u + 6 * v ^ 4 + 54 * v ^ 3 + 162 * v ^ 2 + 162 * v) * ((-R / 2)^2 + (-R * Real.sqrt 3 / 2)^2) + (6 * R * u ^ 4 * v ^ 4 - 18 * R * u ^ 4 * v ^ 3 + 30 * R * u ^ 4 * v ^ 2 - 30 * R * u ^ 4 * v + 12 * R * u ^ 4 - 24 * R * u ^ 3 * v ^ 4 + 12 * R * u ^ 3 * v ^ 3 - 12 * R * u ^ 3 * v ^ 2 - 12 * R * u ^ 3 * v + 36 * R * u ^ 3 + 36 * R * u ^ 2 * v ^ 4 + 48 * R * u ^ 2 * v ^ 3 + 72 * R * u ^ 2 * v ^ 2 + 144 * R * u ^ 2 * v - 108 * R * u ^ 2 - 24 * R * u * v ^ 4 - 60 * R * u * v ^ 3 - 36 * R * u * v ^ 2 - 324 * R * u * v - 324 * R * u + 6 * R * v ^ 4 + 18 * R * v ^ 3 - 54 * R * v ^ 2 - 162 * R * v) * (-R / 2) + ((-1) * 2 * R * u ^ 4 * v ^ 4 * Real.sqrt 3 + 10 * R * u ^ 4 * v ^ 3 * Real.sqrt 3 - 14 * R * u ^ 4 * v ^ 2 * Real.sqrt 3 + 6 * R * u ^ 4 * v * Real.sqrt 3 + 4 * R * u ^ 3 * v ^ 4 * Real.sqrt 3 - 4 * R * u ^ 3 * v ^ 3 * Real.sqrt 3 - 36 * R * u ^ 3 * v ^ 2 * Real.sqrt 3 + 36 * R * u ^ 3 * v * Real.sqrt 3 - 8 * R * u ^ 2 * v ^ 4 * Real.sqrt 3 + 24 * R * u ^ 2 * v ^ 3 * Real.sqrt 3 - 24 * R * u ^ 2 * v ^ 2 * Real.sqrt 3 + 72 * R * u ^ 2 * v * Real.sqrt 3 + 12 * R * u * v ^ 4 * Real.sqrt 3 - 12 * R * u * v ^ 3 * Real.sqrt 3 - 108 * R * u * v ^ 2 * Real.sqrt 3 + 108 * R * u * v * Real.sqrt 3 - 6 * R * v ^ 4 * Real.sqrt 3 - 18 * R * v ^ 3 * Real.sqrt 3 + 54 * R * v ^ 2 * Real.sqrt 3 + 162 * R * v * Real.sqrt 3) * (-R * Real.sqrt 3 / 2) + (12 * R ^ 2 * u ^ 4 * v ^ 2 - 24 * R ^ 2 * u ^ 4 * v + 12 * R ^ 2 * u ^ 4 - 24 * R ^ 2 * u ^ 3 * v ^ 2 - 48 * R ^ 2 * u ^ 3 * v + 72 * R ^ 2 * u ^ 3 - 12 * R ^ 2 * u ^ 2 * v ^ 4 + 24 * R ^ 2 * u ^ 2 * v ^ 3 + 72 * R ^ 2 * u ^ 2 * v + 108 * R ^ 2 * u ^ 2 + 24 * R ^ 2 * u * v ^ 4 + 48 * R ^ 2 * u * v ^ 3 - 72 * R ^ 2 * u * v ^ 2 - 12 * R ^ 2 * v ^ 4 - 72 * R ^ 2 * v ^ 3 - 108 * R ^ 2 * v ^ 2) = 0 := by linarith only [incCCaux u v R hw]
...
lemma incCC1 (u v u₃ R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3)
    (hrel : u₃ * (3 + u + v - u * v) = 3 - u * v - 3 * u - 3 * v) : (6 * u ^ 4 * v ^ 3 - 18 * u ^ 4 * v ^ 2 + 18 * u ^ 4 * v - 6 * u ^ 4 - 6 * u ^ 3 * v ^ 4 - 36 * u ^ 3 * v ^ 2 + 96 * u ^ 3 * v - 54 * u ^ 3 + 18 * u ^ 2 * v ^ 4 + 36 * u ^ 2 * v ^ 3 + 108 * u ^ 2 * v - 162 * u ^ 2 - 18 * u * v ^ 4 - 96 * u * v ^ 3 - 108 * u * v ^ 2 - 162 * u + 6 * v ^ 4 + 54 * v ^ 3 + 162 * v ^ 2 + 162 * v) * ((R * (1 - u₃) / 4)^2 + (R * Real.sqrt 3 * (1 - u₃) / 4)^2) + (6 * R * u ^ 4 * v ^ 4 - 18 * R * u ^ 4 * v ^ 3 + 30 * R * u ^ 4 * v ^ 2 - 30 * R * u ^ 4 * v + 12 * R * u ^ 4 - 24 * R * u ^ 3 * v ^ 4 + 12 * R * u ^ 3 * v ^ 3 - 12 * R * u ^ 3 * v ^ 2 - 12 * R * u ^ 3 * v + 36 * R * u ^ 3 + 36 * R * u ^ 2 * v ^ 4 + 48 * R * u ^ 2 * v ^ 3 + 72 * R * u ^ 2 * v ^ 2 + 144 * R * u ^ 2 * v - 108 * R * u ^ 2 - 24 * R * u * v ^ 4 - 60 * R * u * v ^ 3 - 36 * R * u * v ^ 2 - 324 * R * u * v - 324 * R * u + 6 * R * v ^ 4 + 18 * R * v ^ 3 - 54 * R * v ^ 2 - 162 * R * v) * (R * (1 - u₃) / 4) + ((-1) * 2 * R * u ^ 4 * v ^ 4 * Real.sqrt 3 + 10 * R * u ^ 4 * v ^ 3 * Real.sqrt 3 - 14 * R * u ^ 4 * v ^ 2 * Real.sqrt 3 + 6 * R * u ^ 4 * v * Real.sqrt 3 + 4 * R * u ^ 3 * v ^ 4 * Real.sqrt 3 - 4 * R * u ^ 3 * v ^ 3 * Real.sqrt 3 - 36 * R * u ^ 3 * v ^ 2 * Real.sqrt 3 + 36 * R * u ^ 3 * v * Real.sqrt 3 - 8 * R * u ^ 2 * v ^ 4 * Real.sqrt 3 + 24 * R * u ^ 2 * v ^ 3 * Real.sqrt 3 - 24 * R * u ^ 2 * v ^ 2 * Real.sqrt 3 + 72 * R * u ^ 2 * v * Real.sqrt 3 + 12 * R * u * v ^ 4 * Real.sqrt 3 - 12 * R * u * v ^ 3 * Real.sqrt 3 - 108 * R * u * v ^ 2 * Real.sqrt 3 + 108 * R * u * v * Real.sqrt 3 - 6 * R * v ^ 4 * Real.sqrt 3 - 18 * R * v ^ 3 * Real.sqrt 3 + 54 * R * v ^ 2 * Real.sqrt 3 + 162 * R * v * Real.sqrt 3) * (R * Real.sqrt 3 * (1 - u₃) / 4) + (12 * R ^ 2 * u ^ 4 * v ^ 2 - 24 * R ^ 2 * u ^ 4 * v + 12 * R ^ 2 * u ^ 4 - 24 * R ^ 2 * u ^ 3 * v ^ 2 - 48 * R ^ 2 * u ^ 3 * v + 72 * R ^ 2 * u ^ 3 - 12 * R ^ 2 * u ^ 2 * v ^ 4 + 24 * R ^ 2 * u ^ 2 * v ^ 3 + 72 * R ^ 2 * u ^ 2 * v + 108 * R ^ 2 * u ^ 2 + 24 * R ^ 2 * u * v ^ 4 + 48 * R ^ 2 * u * v ^ 3 - 72 * R ^ 2 * u * v ^ 2 - 12 * R ^ 2 * v ^ 4 - 72 * R ^ 2 * v ^ 3 - 108 * R ^ 2 * v ^ 2) = 0 := by linarith only [incCC1aux u v u₃ R hw hrel]
lemma incCC2 (u v u₃ R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3)
  ...
  field_simp [hdenD]
  linear_combination ((-1) * 4 * R ^ 2 * u ^ 6 * v ^ 6 + 34 * R ^ 2 * u ^ 6 * v ^ 5 - 102 * R ^ 2 * u ^ 6 * v ^ 4 + 148 * R ^ 2 * u ^ 6 * v ^ 3 - 112 * R ^ 2 * u ^ 6 * v ^ 2 + 42 * R ^ 2 * u ^ 6 * v - 6 * R ^ 2 * u ^ 6 + 18 * R ^ 2 * u ^ 5 * v ^ 6 - 144 * R ^ 2 * u ^ 5 * v ^ 5 + 282 * R ^ 2 * u ^ 5 * v ^ 4 - 144 * R ^ 2 * u ^ 5 * v ^ 3 - 90 * R ^ 2 * u ^ 5 * v ^ 2 + 96 * R ^ 2 * u ^ 5 * v - 18 * R ^ 2 * u ^ 5 - 6 * R ^ 2 * u ^ 4 * v ^ 6 + 162 * R ^ 2 * u ^ 4 * v ^ 5 + 96 * R ^ 2 * u ^ 4 * v ^ 4 - 924 * R ^ 2 * u ^ 4 * v ^ 3 + 1050 * R ^ 2 * u ^ 4 * v ^ 2 - 486 * R ^ 2 * u ^ 4 * v + 108 * R ^ 2 * u ^ 4 - 68 * R ^ 2 * u ^ 3 * v ^ 6 - 256 * R ^ 2 * u ^ 3 * v ^ 5 - 84 * R ^ 2 * u ^ 3 * v ^ 4 + 480 * R ^ 2 * u ^ 3 * v ^ 3 + 468 * R ^ 2 * u ^ 3 * v ^ 2 - 864 * R ^ 2 * u ^ 3 * v + 324 * R ^ 2 * u ^ 3 + 120 * R ^ 2 * u ^ 2 * v ^ 6 + 630 * R ^ 2 * u ^ 2 * v ^ 5 + 402 * R ^ 2 * u ^ 2 * v ^ 4 - 1476 * R ^ 2 * u ^ 2 * v ^ 3 - 324 * R ^ 2 * u ^ 2 * v ^ 2 + 1134 * R ^ 2 * u ^ 2 * v - 486 * R ^ 2 * u ^ 2 - 78 * R ^ 2 * u * v ^ 6 - 624 * R ^ 2 * u * v ^ 5 - 1350 * R ^ 2 * u * v ^ 4 + 432 * R ^ 2 * u * v ^ 3 + 3078 * R ^ 2 * u * v ^ 2 - 1458 * R ^ 2 * u + 18 * R ^ 2 * v ^ 6 + 198 * R ^ 2 * v ^ 5 + 756 * R ^ 2 * v ^ 4 + 972 * R ^ 2 * v ^ 3 - 486 * R ^ 2 * v ^ 2 - 1458 * R ^ 2 * v) * hw
lemma hepsA2eqL (u v R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3) : ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3)^2 = (48 * R^2 * (v^2+3)^2 * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9)^2) := by linear_combination (16 * R ^ 2 * u ^ 4 * v ^ 8 - 192 * R ^ 2 * u ^ 4 * v ^ 7 + 960 * R ^ 2 * u ^ 4 * v ^ 6 - 2880 * R ^ 2 * u ^ 4 * v ^ 5 + 6624 * R ^ 2 * u ^ 4 * v ^ 4 - 12096 * R ^ 2 * u ^ 4 * v ^ 3 + 15552 * R ^ 2 * u ^ 4 * v ^ 2 - 15552 * R ^ 2 * u ^ 4 * v + 11664 * R ^ 2 * u ^ 4 + 768 * R ^ 2 * u ^ 3 * v ^ 7 - 4608 * R ^ 2 * u ^ 3 * v ^ 6 + 11520 * R ^ 2 * u ^ 3 * v ^ 5 - 27648 * R ^ 2 * u ^ 3 * v ^ 4 + 48384 * R ^ 2 * u ^ 3 * v ^ 3 - 41472 * R ^ 2 * u ^ 3 * v ^ 2 + 62208 * R ^ 2 * u ^ 3 * v + 480 * R ^ 2 * u ^ 2 * v ^ 8 - 3456 * R ^ 2 * u ^ 2 * v ^ 7 + 19584 * R ^ 2 * u ^ 2 * v ^ 6 - 24192 * R ^ 2 * u ^ 2 * v ^ 5 + 101952 * R ^ 2 * u ^ 2 * v ^ 4 - 51840 * R ^ 2 * u ^ 2 * v ^ 3 + 134784 * R ^ 2 * u ^ 2 * v ^ 2 - 31104 * R ^ 2 * u ^ 2 * v - 23328 * R ^ 2 * u ^ 2 + 11520 * R ^ 2 * u * v ^ 7 - 13824 * R ^ 2 * u * v ^ 6 + 62208 * R ^ 2 * u * v ^ 5 - 82944 * R ^ 2 * u * v ^ 4 + 62208 * R ^ 2 * u * v ^ 3 - 124416 * R ^ 2 * u * v ^ 2 - 62208 * R ^ 2 * u * v + 3600 * R ^ 2 * v ^ 8 - 8640 * R ^ 2 * v ^ 7 + 22464 * R ^ 2 * v ^ 6 - 46656 * R ^ 2 * v ^ 5 + 38880 * R ^ 2 * v ^ 4 - 46656 * R ^ 2 * v ^ 3 + 15552 * R ^ 2 * v ^ 2 + 46656 * R ^ 2 * v + 11664 * R ^ 2) * hw

lemma hbe2eqL (u v R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3) : ((-96) * R * (u^2+3) * (v^2+3) * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * Real.sqrt 3)^2 = (27648 * R^2 * (u^2+3)^2 * (v^2+3)^2 * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v)^2) := by linear_combination (9216 * R ^ 2 * u ^ 12 * v ^ 10 - 129024 * R ^ 2 * u ^ 12 * v ^ 9 + 783360 * R ^ 2 * u ^ 12 * v ^ 8 - 2875392 * R ^ 2 * u ^ 12 * v ^ 7 + 7686144 * R ^ 2 * u ^ 12 * v ^ 6 - 16257024 * R ^ 2 * u ^ 12 * v ^ 5 + 26707968 * R ^ 2 * u ^ 12 * v ^ 4 - 33841152 * R ^ 2 * u ^ 12 * v ^ 3 + 33592320 * R ^ 2 * u ^ 12 * v ^ 2 - 22394880 * R ^ 2 * u ^ 12 * v + 6718464 * R ^ 2 * u ^ 12 + 18432 * R ^ 2 * u ^ 11 * v ^ 11 - 202752 * R ^ 2 * u ^ 11 * v ^ 10 + 1234944 * R ^ 2 * u ^ 11 * v ^ 9 - 4589568 * R ^ 2 * u ^ 11 * v ^ 8 + 10506240 * R ^ 2 * u ^ 11 * v ^ 7 - 18247680 * R ^ 2 * u ^ 11 * v ^ 6 + 22228992 * R ^ 2 * u ^ 11 * v ^ 5 - 2985984 * R ^ 2 * u ^ 11 * v ^ 4 - 24385536 * R ^ 2 * u ^ 11 * v ^ 3 + 61212672 * R ^ 2 * u ^ 11 * v ^ 2 - 85100544 * R ^ 2 * u ^ 11 * v + 40310784 * R ^ 2 * u ^ 11 + 9216 * R ^ 2 * u ^ 10 * v ^ 12 - 92160 * R ^ 2 * u ^ 10 * v ^ 11 + 387072 * R ^ 2 * u ^ 10 * v ^ 10 - 387072 * R ^ 2 * u ^ 10 * v ^ 9 + 2239488 * R ^ 2 * u ^ 10 * v ^ 8 + 3649536 * R ^ 2 * u ^ 10 * v ^ 7 - 331776 * R ^ 2 * u ^ 10 * v ^ 6 + 12939264 * R ^ 2 * u ^ 10 * v ^ 5 - 14681088 * R ^ 2 * u ^ 10 * v ^ 4 - 25380864 * R ^ 2 * u ^ 10 * v ^ 3 + 19408896 * R ^ 2 * u ^ 10 * v ^ 2 - 85100544 * R ^ 2 * u ^ 10 * v + 87340032 * R ^ 2 * u ^ 10 - 18432 * R ^ 2 * u ^ 9 * v ^ 12 - 313344 * R ^ 2 * u ^ 9 * v ^ 11 + 1050624 * R ^ 2 * u ^ 9 * v ^ 10 - 5363712 * R ^ 2 * u ^ 9 * v ^ 9 - 12939264 * R ^ 2 * u ^ 9 * v ^ 8 - 12275712 * R ^ 2 * u ^ 9 * v ^ 7 - 76640256 * R ^ 2 * u ^ 9 * v ^ 6 - 995328 * R ^ 2 * u ^ 9 * v ^ 5 + 28366848 * R ^ 2 * u ^ 9 * v ^ 4 - 126904320 * R ^ 2 * u ^ 9 * v ^ 3 + 389670912 * R ^ 2 * u ^ 9 * v ^ 2 - 344881152 * R ^ 2 * u ^ 9 * v + 161243136 * R ^ 2 * u ^ 9 - 101376 * R ^ 2 * u ^ 8 * v ^ 12 + 829440 * R ^ 2 * u ^ 8 * v ^ 11 + 248832 * R ^ 2 * u ^ 8 * v ^ 10 + 12939264 * R ^ 2 * u ^ 8 * v ^ 9 + 12275712 * R ^ 2 * u ^ 8 * v ^ 8 + 196079616 * R ^ 2 * u ^ 8 * v ^ 7 - 57231360 * R ^ 2 * u ^ 8 * v ^ 6 + 883851264 * R ^ 2 * u ^ 8 * v ^ 5 - 581520384 * R ^ 2 * u ^ 8 * v ^ 4 + 1070475264 * R ^ 2 * u ^ 8 * v ^ 3 - 866681856 * R ^ 2 * u ^ 8 * v ^ 2 - 295612416 * R ^ 2 * u ^ 8 * v + 228427776 * R ^ 2 * u ^ 8 + 221184 * R ^ 2 * u ^ 7 * v ^ 12 - 110592 * R ^ 2 * u ^ 7 * v ^ 11 + 12275712 * R ^ 2 * u ^ 7 * v ^ 10 - 64032768 * R ^ 2 * u ^ 7 * v ^ 9 + 14929920 * R ^ 2 * u ^ 7 * v ^ 8 - 487710720 * R ^ 2 * u ^ 7 * v ^ 7 - 280682496 * R ^ 2 * u ^ 7 * v ^ 6 - 1152589824 * R ^ 2 * u ^ 7 * v ^ 5 - 859963392 * R ^ 2 * u ^ 7 * v ^ 4 - 618098688 * R ^ 2 * u ^ 7 * v ^ 3 - 618098688 * R ^ 2 * u ^ 7 * v ^ 2 + 510603264 * R ^ 2 * u ^ 7 * v - 80621568 * R ^ 2 * u ^ 7 - 276480 * R ^ 2 * u ^ 6 * v ^ 12 + 2322432 * R ^ 2 * u ^ 6 * v ^ 11 - 16257024 * R ^ 2 * u ^ 6 * v ^ 10 + 8957952 * R ^ 2 * u ^ 6 * v ^ 9 + 98039808 * R ^ 2 * u ^ 6 * v ^ 8 + 567336960 * R ^ 2 * u ^ 6 * v ^ 7 + 1009262592 * R ^ 2 * u ^ 6 * v ^ 6 + 3242778624 * R ^ 2 * u ^ 6 * v ^ 5 + 1742321664 * R ^ 2 * u ^ 6 * v ^ 4 + 4165447680 * R ^ 2 * u ^ 6 * v ^ 3 - 26873856 * R ^ 2 * u ^ 6 * v ^ 2 - 1531809792 * R ^ 2 * u ^ 6 * v - 201553920 * R ^ 2 * u ^ 6 + 331776 * R ^ 2 * u ^ 5 * v ^ 12 + 10285056 * R ^ 2 * u ^ 5 * v ^ 11 + 14929920 * R ^ 2 * u ^ 5 * v ^ 10 - 48771072 * R ^ 2 * u ^ 5 * v ^ 9 - 1080926208 * R ^ 2 * u ^ 5 * v ^ 7 - 1307860992 * R ^ 2 * u ^ 5 * v ^ 6 - 3744423936 * R ^ 2 * u ^ 5 * v ^ 5 - 6422851584 * R ^ 2 * u ^ 5 * v ^ 4 - 2714259456 * R ^ 2 * u ^ 5 * v ^ 3 - 8787750912 * R ^ 2 * u ^ 5 * v ^ 2 + 2821754880 * R ^ 2 * u ^ 5 * v - 483729408 * R ^ 2 * u ^ 5 + 2820096 * R ^ 2 * u ^ 4 * v ^ 12 - 16920576 * R ^ 2 * u ^ 4 * v ^ 11 - 50512896 * R ^ 2 * u ^ 4 * v ^ 10 - 279189504 * R ^ 2 * u ^ 4 * v ^ 9 + 278443008 * R ^ 2 * u ^ 4 * v ^ 8 - 429981696 * R ^ 2 * u ^ 4 * v ^ 7 + 4752193536 * R ^ 2 * u ^ 4 * v ^ 6 + 2982998016 * R ^ 2 * u ^ 4 * v ^ 5 + 14323765248 * R ^ 2 * u ^ 4 * v ^ 4 + 6207860736 * R ^ 2 * u ^ 4 * v ^ 3 + 12274633728 * R ^ 2 * u ^ 4 * v ^ 2 - 1330255872 * R ^ 2 * u ^ 4 * v - 665127936 * R ^ 2 * u ^ 4 - 5971968 * R ^ 2 * u ^ 3 * v ^ 12 + 23390208 * R ^ 2 * u ^ 3 * v ^ 11 - 46282752 * R ^ 2 * u ^ 3 * v ^ 10 + 356825088 * R ^ 2 * u ^ 3 * v ^ 9 + 58226688 * R ^ 2 * u ^ 3 * v ^ 8 + 1101828096 * R ^ 2 * u ^ 3 * v ^ 7 - 1155575808 * R ^ 2 * u ^ 3 * v ^ 6 - 456855552 * R ^ 2 * u ^ 3 * v ^ 5 - 11045154816 * R ^ 2 * u ^ 3 * v ^ 4 - 3426416640 * R ^ 2 * u ^ 3 * v ^ 3 - 18744514560 * R ^ 2 * u ^ 3 * v ^ 2 + 362797056 * R ^ 2 * u ^ 3 * v + 362797056 * R ^ 2 * u ^ 3 + 9704448 * R ^ 2 * u ^ 2 * v ^ 12 - 37324800 * R ^ 2 * u ^ 2 * v ^ 11 + 19408896 * R ^ 2 * u ^ 2 * v ^ 10 - 550914048 * R ^ 2 * u ^ 2 * v ^ 9 + 584506368 * R ^ 2 * u ^ 2 * v ^ 8 - 2391773184 * R ^ 2 * u ^ 2 * v ^ 7 + 6422851584 * R ^ 2 * u ^ 2 * v ^ 6 - 3144241152 * R ^ 2 * u ^ 2 * v ^ 5 + 20981763072 * R ^ 2 * u ^ 2 * v ^ 4 + 1330255872 * R ^ 2 * u ^ 2 * v ^ 3 + 21888755712 * R ^ 2 * u ^ 2 * v ^ 2 + 3265173504 * R ^ 2 * u ^ 2 * v + 544195584 * R ^ 2 * u ^ 2 - 13436928 * R ^ 2 * u * v ^ 12 + 4478976 * R ^ 2 * u * v ^ 11 - 76142592 * R ^ 2 * u * v ^ 10 + 515082240 * R ^ 2 * u * v ^ 9 + 510603264 * R ^ 2 * u * v ^ 8 + 3412979712 * R ^ 2 * u * v ^ 7 + 2499268608 * R ^ 2 * u * v ^ 6 + 6691590144 * R ^ 2 * u * v ^ 5 - 1572120576 * R ^ 2 * u * v ^ 4 + 1813985280 * R ^ 2 * u * v ^ 3 - 10521114624 * R ^ 2 * u * v ^ 2 - 3265173504 * R ^ 2 * u * v + 6718464 * R ^ 2 * v ^ 12 + 13436928 * R ^ 2 * v ^ 11 + 141087744 * R ^ 2 * v ^ 10 + 53747712 * R ^ 2 * v ^ 9 + 873400320 * R ^ 2 * v ^ 8 - 886837248 * R ^ 2 * v ^ 7 + 2700822528 * R ^ 2 * v ^ 6 - 5321023488 * R ^ 2 * v ^ 5 + 5139624960 * R ^ 2 * v ^ 4 - 7618738176 * R ^ 2 * v ^ 3 + 4897760256 * R ^ 2 * v ^ 2) * hw

lemma hbeepseqL (u v R : ℝ) (hw : (Real.sqrt 3 : ℝ)^2 = 3) : ((-96) * R * (u^2+3) * (v^2+3) * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * Real.sqrt 3) * ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) = (1152 * R^2 * (u^2+3) * (v^2+3)^2 * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9)) := by linear_combination (384 * R ^ 2 * u ^ 8 * v ^ 9 - 4992 * R ^ 2 * u ^ 8 * v ^ 8 + 27648 * R ^ 2 * u ^ 8 * v ^ 7 - 92160 * R ^ 2 * u ^ 8 * v ^ 6 + 228096 * R ^ 2 * u ^ 8 * v ^ 5 - 449280 * R ^ 2 * u ^ 8 * v ^ 4 + 663552 * R ^ 2 * u ^ 8 * v ^ 3 - 746496 * R ^ 2 * u ^ 8 * v ^ 2 + 653184 * R ^ 2 * u ^ 8 * v - 279936 * R ^ 2 * u ^ 8 + 384 * R ^ 2 * u ^ 7 * v ^ 10 - 3840 * R ^ 2 * u ^ 7 * v ^ 9 + 31104 * R ^ 2 * u ^ 7 * v ^ 8 - 138240 * R ^ 2 * u ^ 7 * v ^ 7 + 338688 * R ^ 2 * u ^ 7 * v ^ 6 - 705024 * R ^ 2 * u ^ 7 * v ^ 5 + 1140480 * R ^ 2 * u ^ 7 * v ^ 4 - 912384 * R ^ 2 * u ^ 7 * v ^ 3 + 902016 * R ^ 2 * u ^ 7 * v ^ 2 + 186624 * R ^ 2 * u ^ 7 * v - 839808 * R ^ 2 * u ^ 7 - 384 * R ^ 2 * u ^ 6 * v ^ 10 + 11520 * R ^ 2 * u ^ 6 * v ^ 9 - 63360 * R ^ 2 * u ^ 6 * v ^ 8 + 359424 * R ^ 2 * u ^ 6 * v ^ 7 - 449280 * R ^ 2 * u ^ 6 * v ^ 6 + 1617408 * R ^ 2 * u ^ 6 * v ^ 5 - 1057536 * R ^ 2 * u ^ 6 * v ^ 4 + 1244160 * R ^ 2 * u ^ 6 * v ^ 3 - 902016 * R ^ 2 * u ^ 6 * v ^ 2 - 2052864 * R ^ 2 * u ^ 6 * v - 279936 * R ^ 2 * u ^ 6 + 3456 * R ^ 2 * u ^ 5 * v ^ 10 - 25344 * R ^ 2 * u ^ 5 * v ^ 9 + 31104 * R ^ 2 * u ^ 5 * v ^ 8 - 580608 * R ^ 2 * u ^ 5 * v ^ 7 - 269568 * R ^ 2 * u ^ 5 * v ^ 6 - 2198016 * R ^ 2 * u ^ 5 * v ^ 5 - 2177280 * R ^ 2 * u ^ 5 * v ^ 4 - 248832 * R ^ 2 * u ^ 5 * v ^ 3 - 3825792 * R ^ 2 * u ^ 5 * v ^ 2 + 5412096 * R ^ 2 * u ^ 5 * v - 839808 * R ^ 2 * u ^ 5 - 3456 * R ^ 2 * u ^ 4 * v ^ 10 - 165888 * R ^ 2 * u ^ 4 * v ^ 9 + 114048 * R ^ 2 * u ^ 4 * v ^ 8 - 248832 * R ^ 2 * u ^ 4 * v ^ 7 + 2923776 * R ^ 2 * u ^ 4 * v ^ 6 + 1741824 * R ^ 2 * u ^ 4 * v ^ 5 + 14245632 * R ^ 2 * u ^ 4 * v ^ 4 - 746496 * R ^ 2 * u ^ 4 * v ^ 3 + 20248704 * R ^ 2 * u ^ 4 * v ^ 2 - 11197440 * R ^ 2 * u ^ 4 * v + 1399680 * R ^ 2 * u ^ 4 - 44928 * R ^ 2 * u ^ 3 * v ^ 10 + 172800 * R ^ 2 * u ^ 3 * v ^ 9 - 155520 * R ^ 2 * u ^ 3 * v ^ 8 + 1575936 * R ^ 2 * u ^ 3 * v ^ 7 - 3794688 * R ^ 2 * u ^ 3 * v ^ 6 + 5847552 * R ^ 2 * u ^ 3 * v ^ 5 - 22954752 * R ^ 2 * u ^ 3 * v ^ 4 + 11197440 * R ^ 2 * u ^ 3 * v ^ 3 - 33872256 * R ^ 2 * u ^ 3 * v ^ 2 + 9517824 * R ^ 2 * u ^ 3 * v + 4199040 * R ^ 2 * u ^ 3 + 44928 * R ^ 2 * u ^ 2 * v ^ 10 - 601344 * R ^ 2 * u ^ 2 * v ^ 9 + 1358208 * R ^ 2 * u ^ 2 * v ^ 8 - 4230144 * R ^ 2 * u ^ 2 * v ^ 7 + 12752640 * R ^ 2 * u ^ 2 * v ^ 6 - 8584704 * R ^ 2 * u ^ 2 * v ^ 5 + 44603136 * R ^ 2 * u ^ 2 * v ^ 4 - 2239488 * R ^ 2 * u ^ 2 * v ^ 3 + 51788160 * R ^ 2 * u ^ 2 * v ^ 2 + 5038848 * R ^ 2 * u ^ 2 * v - 839808 * R ^ 2 * u ^ 2 - 155520 * R ^ 2 * u * v ^ 10 + 642816 * R ^ 2 * u * v ^ 9 + 93312 * R ^ 2 * u * v ^ 8 + 6220800 * R ^ 2 * u * v ^ 7 + 186624 * R ^ 2 * u * v ^ 6 + 18289152 * R ^ 2 * u * v ^ 5 - 18475776 * R ^ 2 * u * v ^ 4 + 11197440 * R ^ 2 * u * v ^ 3 - 42830208 * R ^ 2 * u * v ^ 2 - 15116544 * R ^ 2 * u * v - 2519424 * R ^ 2 * u + 155520 * R ^ 2 * v ^ 10 - 31104 * R ^ 2 * v ^ 9 + 1741824 * R ^ 2 * v ^ 8 - 2985984 * R ^ 2 * v ^ 7 + 7278336 * R ^ 2 * v ^ 6 - 16236288 * R ^ 2 * v ^ 5 + 13436928 * R ^ 2 * v ^ 4 - 20155392 * R ^ 2 * v ^ 3 + 9237888 * R ^ 2 * v ^ 2 + 7558272 * R ^ 2 * v) * hw
...
lemma hRtmp0eqL (u v R : ℝ) : (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3))^2 + (48 * R^2 * (v^2+3)^2 * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9)^2) - 4 * ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) = (192 * R^2 * (u^2+3) * (v^2+3)^3 * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 - 6 * u * v ^ 2 + 24 * u * v - 18 * u + 21 * v ^ 2 - 18 * v + 9)) := by ring
...
lemma bigidL (u v R : ℝ) (h4 : 12 * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)^2 * (-(u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 13 * u ^ 3 * v ^ 3 + 45 * u ^ 3 * v ^ 2 - 51 * u ^ 3 * v + 18 * u ^ 3 - 7 * u ^ 2 * v ^ 4 + 45 * u ^ 2 * v ^ 3 - 90 * u ^ 2 * v ^ 2 + 45 * u ^ 2 * v - 9 * u ^ 2 + 15 * u * v ^ 4 - 51 * u * v ^ 3 + 45 * u * v ^ 2 - 9 * u * v - 9 * v ^ 4 + 18 * v ^ 3 - 9 * v ^ 2)) + (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 10 * u ^ 3 * v ^ 3 + 24 * u ^ 3 * v ^ 2 - 6 * u ^ 3 * v - 9 * u ^ 3 - u ^ 2 * v ^ 4 + 6 * u ^ 2 * v ^ 3 + 36 * u ^ 2 * v ^ 2 - 54 * u ^ 2 * v + 45 * u ^ 2 - 9 * u * v ^ 4 + 30 * u * v ^ 3 - 108 * u * v ^ 2 + 18 * u * v - 27 * u + 9 * v ^ 4 - 27 * v ^ 3 - 9 * v ^ 2 + 27 * v)^2 = (u ^ 6 * v ^ 4 - 8 * u ^ 6 * v ^ 3 + 22 * u ^ 6 * v ^ 2 - 24 * u ^ 6 * v + 9 * u ^ 6 + 2 * u ^ 5 * v ^ 5 - 16 * u ^ 5 * v ^ 4 + 32 * u ^ 5 * v ^ 3 + 12 * u ^ 5 * v ^ 2 - 66 * u ^ 5 * v + 36 * u ^ 5 + u ^ 4 * v ^ 6 - 16 * u ^ 4 * v ^ 5 + 36 * u ^ 4 * v ^ 4 + 132 * u ^ 4 * v ^ 3 - 351 * u ^ 4 * v ^ 2 + 108 * u ^ 4 * v + 90 * u ^ 4 - 8 * u ^ 3 * v ^ 6 + 32 * u ^ 3 * v ^ 5 + 132 * u ^ 3 * v ^ 4 - 696 * u ^ 3 * v ^ 3 + 72 * u ^ 3 * v ^ 2 + 792 * u ^ 3 * v - 324 * u ^ 3 + 22 * u ^ 2 * v ^ 6 + 12 * u ^ 2 * v ^ 5 - 351 * u ^ 2 * v ^ 4 + 72 * u ^ 2 * v ^ 3 + 1836 * u ^ 2 * v ^ 2 - 756 * u ^ 2 * v + 189 * u ^ 2 - 24 * u * v ^ 6 - 66 * u * v ^ 5 + 108 * u * v ^ 4 + 792 * u * v ^ 3 - 756 * u * v ^ 2 - 54 * u * v + 9 * v ^ 6 + 36 * v ^ 5 + 90 * v ^ 4 - 324 * v ^ 3 + 189 * v ^ 2) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 - 6 * u * v ^ 2 + 24 * u * v - 18 * u + 21 * v ^ 2 - 18 * v + 9)) : ((21233664 * R^4 * (u^2+3)^4 * (v^2+3)^6) * (12 * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)^2 * (-(u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 13 * u ^ 3 * v ^ 3 + 45 * u ^ 3 * v ^ 2 - 51 * u ^ 3 * v + 18 * u ^ 3 - 7 * u ^ 2 * v ^ 4 + 45 * u ^ 2 * v ^ 3 - 90 * u ^ 2 * v ^ 2 + 45 * u ^ 2 * v - 9 * u ^ 2 + 15 * u * v ^ 4 - 51 * u * v ^ 3 + 45 * u * v ^ 2 - 9 * u * v - 9 * v ^ 4 + 18 * v ^ 3 - 9 * v ^ 2)))) + ((-4608) * R^2 * (u^2+3)^2 * (v^2+3)^3 * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 10 * u ^ 3 * v ^ 3 + 24 * u ^ 3 * v ^ 2 - 6 * u ^ 3 * v - 9 * u ^ 3 - u ^ 2 * v ^ 4 + 6 * u ^ 2 * v ^ 3 + 36 * u ^ 2 * v ^ 2 - 54 * u ^ 2 * v + 45 * u ^ 2 - 9 * u * v ^ 4 + 30 * u * v ^ 3 - 108 * u * v ^ 2 + 18 * u * v - 27 * u + 9 * v ^ 4 - 27 * v ^ 3 - 9 * v ^ 2 + 27 * v))^2 = (110592 * R^2 * (u^2+3)^3 * (v^2+3)^3 * (u ^ 6 * v ^ 4 - 8 * u ^ 6 * v ^ 3 + 22 * u ^ 6 * v ^ 2 - 24 * u ^ 6 * v + 9 * u ^ 6 + 2 * u ^ 5 * v ^ 5 - 16 * u ^ 5 * v ^ 4 + 32 * u ^ 5 * v ^ 3 + 12 * u ^ 5 * v ^ 2 - 66 * u ^ 5 * v + 36 * u ^ 5 + u ^ 4 * v ^ 6 - 16 * u ^ 4 * v ^ 5 + 36 * u ^ 4 * v ^ 4 + 132 * u ^ 4 * v ^ 3 - 351 * u ^ 4 * v ^ 2 + 108 * u ^ 4 * v + 90 * u ^ 4 - 8 * u ^ 3 * v ^ 6 + 32 * u ^ 3 * v ^ 5 + 132 * u ^ 3 * v ^ 4 - 696 * u ^ 3 * v ^ 3 + 72 * u ^ 3 * v ^ 2 + 792 * u ^ 3 * v - 324 * u ^ 3 + 22 * u ^ 2 * v ^ 6 + 12 * u ^ 2 * v ^ 5 - 351 * u ^ 2 * v ^ 4 + 72 * u ^ 2 * v ^ 3 + 1836 * u ^ 2 * v ^ 2 - 756 * u ^ 2 * v + 189 * u ^ 2 - 24 * u * v ^ 6 - 66 * u * v ^ 5 + 108 * u * v ^ 4 + 792 * u * v ^ 3 - 756 * u * v ^ 2 - 54 * u * v + 9 * v ^ 6 + 36 * v ^ 5 + 90 * v ^ 4 - 324 * v ^ 3 + 189 * v ^ 2)) * (192 * R^2 * (u^2+3) * (v^2+3)^3 * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 - 6 * u * v ^ 2 + 24 * u * v - 18 * u + 21 * v ^ 2 - 18 * v + 9)) := by
  linear_combination (21233664 * R^4 * (u^2+3)^4 * (v^2+3)^6) * h4

lemma hradBL (u v R : ℝ) (x y : ℝ) : (24 * (u^2+3) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3)) * (((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (x^2+y^2) + (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * x + ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) * y + ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3))) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((24 * (u^2+3) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3)) * (x^2+y^2) + (12 * R * (u^2+3) * (u ^ 2 * v ^ 2 + 7 * u ^ 2 - 4 * u * v ^ 2 + 8 * u * v - 12 * u + 3 * v ^ 2 - 3)) * x + ((-4) * R * (u^2+3) * (u*v - 3*u - 3*v - 3) * (u*v + 3*u + 3*v - 3) * Real.sqrt 3) * y + (12 * R^2 * (u^2+3) * (v-1) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3))) = (288 * R * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 3 * v - u ^ 3 + u ^ 2 * v ^ 2 - u ^ 2 * v - 4 * u * v ^ 2 + 3 * u * v - 15 * u + 3 * v ^ 2 - 3 * v)) * x + ((-96) * R * (u^2+3) * (v^2+3) * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * Real.sqrt 3) * y + ((-288) * R^2 * (u-v) * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3)) := by ring

lemma hradCL (u v R : ℝ) (x y : ℝ) : (6 * (u-v) * (u*v - u - v - 3)^3) * (((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (x^2+y^2) + (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * x + ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) * y + ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3))) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((6 * (u-v) * (u*v - u - v - 3)^3) * (x^2+y^2) + (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v)) * x + ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3) * y + (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) = ((6 * (u-v) * (u*v - u - v - 3)^3) * (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v))) * x + ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3)) * y + ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) := by ring

lemma hcoaxxL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * (12 * R * (u+1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (6 * R * (u*v - u - v - 3)^2 * (u ^ 2 * v ^ 2 - u ^ 2 * v + 2 * u ^ 2 - 2 * u * v ^ 2 - 6 * u + v ^ 2 - 3 * v))) = (u*v - u - v - 3)^2 * ((288 * R * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 3 * v - u ^ 3 + u ^ 2 * v ^ 2 - u ^ 2 * v - 4 * u * v ^ 2 + 3 * u * v - 15 * u + 3 * v ^ 2 - 3 * v))) := by ring

lemma hcoaxyL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-4) * R * (v^2+3) * (u ^ 2 * v ^ 2 - 6 * u ^ 2 * v + 9 * u ^ 2 + 24 * u * v + 15 * v ^ 2 - 18 * v - 9) * Real.sqrt 3) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * ((-2) * R * v * (u^2+3) * (v-3) * (u*v - u - v - 3)^2 * Real.sqrt 3)) = (u*v - u - v - 3)^2 * (((-96) * R * (u^2+3) * (v^2+3) * (u ^ 4 * v ^ 3 - 7 * u ^ 4 * v ^ 2 + 15 * u ^ 4 * v - 9 * u ^ 4 + u ^ 3 * v ^ 4 - 4 * u ^ 3 * v ^ 3 + 18 * u ^ 3 * v ^ 2 + 12 * u ^ 3 * v - 27 * u ^ 3 - u ^ 2 * v ^ 4 - 18 * u ^ 2 * v ^ 3 - 54 * u ^ 2 * v + 9 * u ^ 2 - 9 * u * v ^ 4 + 12 * u * v ^ 3 + 54 * u * v ^ 2 + 108 * u * v + 27 * u + 9 * v ^ 4 + 9 * v ^ 3 + 63 * v ^ 2 - 81 * v) * Real.sqrt 3)) := by ring

lemma hcoaxcL (u v R : ℝ) : 4 * (u^2+3) * ((6 * (u-v) * (u*v - u - v - 3)^3) * ((-12) * R^2 * (u-1) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) - ((-24) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3)) * (12 * R^2 * (u-v) * (u+v) * (u*v - u - v - 3)^2)) = (u*v - u - v - 3)^2 * (((-288) * R^2 * (u-v) * (u^2+3) * (v^2+3) * (u * v ^ 2 - 2 * u * v - 3 * u - v ^ 2 - 6 * v + 3) * (u ^ 2 * v - u ^ 2 - 2 * u * v - 6 * u - 3 * v + 3))) := by ring
...
lemma sqSfactsL (u v u₃ R : ℝ) (hR : 0 < R) (hu0 : 0 < u) (hu1 : u < 1) (hv0 : 0 < v) (hv1 : v < 1)
  ...
  have hnn0pos : 0 < (nn0d u v R) := by
    have hnn : (ald u v R) ^ 2 + (bed u v R) ^ 2 = (nn0d u v R) := by simp only [ald, bed, nn0d]; rw [hbe2eq, hnn0eq]
    have hge : 0 ≤ (nn0d u v R) := by rw [← hnn]; positivity
    rcases hge.eq_or_lt with h0 | hpos
    · exfalso
      have hBIG : (sqNd u v R) + (trhod u v R) ^ 2 = (nn0d u v R) * (Rtmp0d u v R) := by simp only [sqNd, trhod, nn0d, Rtmp0d]; linear_combination BIGID
      rw [h0.symm, zero_mul] at hBIG
      have hz : (sqNd u v R) ≤ 0 := by nlinarith only [sq_nonneg (trhod u v R), hBIG]
      linarith [hsqNpos, hz]
    · exact hpos
  ...
  have hS2 : (Sd u v R) ^ 2 = (sqNd u v R) / (4 * (sigAd u v) ^ 2 * (nn0d u v R) ^ 2) := by
    simp only [Sd]; rw [div_pow, Real.sq_sqrt (le_of_lt (mul_pos hsqNpos (sq_pos_of_ne_zero hsigA)))]
    field_simp [hsigA, hnn0pos.ne']
    ring
  ...
  have hsqformA : ∀ x y : ℝ, (sigAd u v) * (x ^ 2 + y ^ 2) + (delAd u v R) * x + (epsAd u v R) * y + (phiAd u v R)
      = (sigAd u v) * ((x - (caxd u v R)) ^ 2 + (y - (cayd u v R)) ^ 2 - (RA2d u v R)) := by
    intro x y
    simp only [RA2d, Rtmp0d, caxd, cayd]; rw [← hRtmp0eq, ← hepsA2eq]; field_simp [hsigA]; simp only [sigAd, delAd, epsAd, phiAd]; ring
  have hortho : (ald u v R) * (-(bed u v R)) + (bed u v R) * (ald u v R) = 0 := by ring
  have hnn : (ald u v R) ^ 2 + (bed u v R) ^ 2 = (nn0d u v R) := by simp only [ald, bed, nn0d]; rw [hbe2eq, hnn0eq]
  have hBIG2 : (sqNd u v R) + (trhod u v R) ^ 2 = (nn0d u v R) * (Rtmp0d u v R) := by simp only [sqNd, trhod, nn0d, Rtmp0d]; linear_combination BIGID
...
lemma lineP12L (u v u₃ R : ℝ) (hR : 0 < R) (hu0 : 0 < u) (hu1 : u < 1) (hv0 : 0 < v) (hv1 : v < 1)
  ...
  have hlineM : (ald u v R) * (caxd u v R) + (bed u v R) * (cayd u v R) + (gad u v R) = (trhod u v R) / (2 * (sigAd u v)) := by
    simp only [caxd, cayd]; field_simp [hsigA]; simp only [ald, bed, gad, delAd, epsAd, sigAd, trhod]; linear_combination (-1) * hbeepseq
...
lemma omegaP12L (u v u₃ R : ℝ) (hR : 0 < R) (hu0 : 0 < u) (hu1 : u < 1) (hv0 : 0 < v) (hv1 : v < 1)
  ...
  have hP1omegaB : (sigBd u v) * ((P1xd u v R) ^ 2 + (P1yd u v R) ^ 2) + (delBd u v R) * (P1xd u v R) + (epsBd u v R) * (P1yd u v R) + (phiBd u v R) = 0 := by
    simp only [sigAd, delAd, epsAd, phiAd] at hP1omegaA
    simp only [ald, bed, gad] at hP1line
    ...
    have h' : (sigAd u v) * ((sigBd u v) * ((P1xd u v R) ^ 2 + (P1yd u v R) ^ 2) + (delBd u v R) * (P1xd u v R) + (epsBd u v R) * (P1yd u v R) + (phiBd u v R)) = 0 := by
      simp only [sigAd, sigBd, delBd, epsBd, phiBd]
      linarith [h]
  ...
  have hP2omegaB : (sigBd u v) * ((P2xd u v R) ^ 2 + (P2yd u v R) ^ 2) + (delBd u v R) * (P2xd u v R) + (epsBd u v R) * (P2yd u v R) + (phiBd u v R) = 0 := by
    simp only [sigAd, delAd, epsAd, phiAd] at hP2omegaA
    simp only [ald, bed, gad] at hP2line
  ...
  have hcoaxP1 : 4 * (u ^ 2 + 3) * ((al2d u v R) * (P1xd u v R) + (be2pd u v R) * (P1yd u v R) + (ga2d u v R))
    ...
    simp only [al2d, be2pd, ga2d, sigAd, sigCd, delAd, delCd, epsAd, epsCd, phiAd, phiCd, ald, bed, gad]; linear_combination (P1xd u v R) * hcoaxx + (P1yd u v R) * hcoaxy + hcoaxc
  have hP1omegaC : (sigCd u v) * ((P1xd u v R) ^ 2 + (P1yd u v R) ^ 2) + (delCd u v R) * (P1xd u v R) + (epsCd u v R) * (P1yd u v R) + (phiCd u v R) = 0 := by
    simp only [sigAd, delAd, epsAd, phiAd] at hP1omegaA
    simp only [ald, bed, gad] at hP1line
    simp only [al2d, be2pd, ga2d, sigAd, sigCd, delAd, delCd, epsAd, epsCd, phiAd, phiCd, ald, bed, gad] at hcoaxP1
    ...
    have h2 : 4 * (u ^ 2 + 3) * ((sigCd u v) * 0 - (sigAd u v) *
      ...
      simp only [sigAd, sigCd, delCd, epsCd, phiCd]; rw [h, hcoaxP1, hP1line]; ring
  ...
  have hcoaxP2 : 4 * (u ^ 2 + 3) * ((al2d u v R) * (P2xd u v R) + (be2pd u v R) * (P2yd u v R) + (ga2d u v R))
    ...
    simp only [al2d, be2pd, ga2d, sigAd, sigCd, delAd, delCd, epsAd, epsCd, phiAd, phiCd, ald, bed, gad]; linear_combination (P2xd u v R) * hcoaxx + (P2yd u v R) * hcoaxy + hcoaxc
  have hP2omegaC : (sigCd u v) * ((P2xd u v R) ^ 2 + (P2yd u v R) ^ 2) + (delCd u v R) * (P2xd u v R) + (epsCd u v R) * (P2yd u v R) + (phiCd u v R) = 0 := by
    simp only [sigAd, delAd, epsAd, phiAd] at hP2omegaA
    simp only [ald, bed, gad] at hP2line
    simp only [al2d, be2pd, ga2d, sigAd, sigCd, delAd, delCd, epsAd, epsCd, phiAd, phiCd, ald, bed, gad] at hcoaxP2
    have h := hradC (P2xd u v R) (P2yd u v R)
    rw [hP2omegaA] at h
    have h2 : 4 * (u ^ 2 + 3) * ((sigCd u v) * 0 - (sigAd u v) *
        ((sigCd u v) * ((P2xd u v R) ^ 2 + (P2yd u v R) ^ 2) + (delCd u v R) * (P2xd u v R) + (epsCd u v R) * (P2yd u v R) + (phiCd u v R))) = 0 := by
      simp only [sigAd, sigCd, delCd, epsCd, phiCd]; rw [h, hcoaxP2, hP2line]; ring
    have h3 : 4 * (u ^ 2 + 3) ≠ 0 := by positivity
